...
public class CargaDenunciaEspecial extends JDialog {
	...
	private JTextField textFieldNivelAcademico;

	
	public static void main(String[] args) {
		try {
			CargaDenunciaEspecial dialog = new CargaDenunciaEspecial();
	...
	public CargaDenunciaEspecial() {
		setTitle("Denuncia Especiales");
		...
		lblEdad.setFont(new Font("Calibri", Font.BOLD, 14));
		lblEdad.setBounds(25, 340, 103, 20);
		contentPanel.add(lblEdad);
		
		textFieldOcupacion = new JTextField();
		textFieldOcupacion.setFont(new Font("Calibri", Font.BOLD, 14));
		textFieldOcupacion.setColumns(10);
		textFieldOcupacion.setBounds(379, 340, 239, 20);
		contentPanel.add(textFieldOcupacion);
		
		textFieldEdad = new JTextField();
		textFieldEdad.setFont(new Font("Calibri", Font.BOLD, 14));
		textFieldEdad.setColumns(10);
		textFieldEdad.setBounds(87, 340, 203, 20);
		contentPanel.add(textFieldEdad);
		
		JLabel lblOcupacion = new JLabel("Ocupacion:");
		lblOcupacion.setFont(new Font("Calibri", Font.BOLD, 14));
		lblOcupacion.setBounds(300, 340, 103, 17);
		...
		lblNivelAcademico.setFont(new Font("Calibri", Font.BOLD, 14));
		lblNivelAcademico.setBounds(25, 365, 103, 20);
		contentPanel.add(lblNivelAcademico);
		
		textFieldNivelAcademico = new JTextField();
		textFieldNivelAcademico.setFont(new Font("Calibri", Font.BOLD, 14));
		textFieldNivelAcademico.setColumns(10);
		textFieldNivelAcademico.setBounds(142, 365, 476, 20);
		contentPanel.add(textFieldNivelAcademico);
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				guardarButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						//
						if(!camposVacios(textAreaDescripciones.getText(),textFieldEdad.getText())) {
							if(validarCampos(textFieldEdad.getText()) && camposVaciosNumericos(textFieldNumeroD.getText()) && camposVaciosNumericos(textFieldCodigoPostalD.getText()) && camposVaciosNumericos(textFieldNumero.getText()) && camposVaciosNumericos(textFieldCodigoPostal.getText())){ 
								Controlador c = new Controlador();
								int resultado = -1;
								try {
									resultado = c.guardarDenunciaEspecial(textAreaDescripciones.getText(),textAreaObservaciones.getText(),textFieldNombreDenunciante.getText() ,textFieldCalleD.getText(),textFieldNumeroD.getText(),textFieldDistritoD.getText(),textFieldCiudadD.getText(),textFieldProvinciaD.getText(),textFieldCodigoPostalD.getText(),textFieldTelefonoD.getText(),textFieldEdad.getText(),textFieldNivelAcademico.getText(),textFieldOcupacion.getText(),textFieldCalle.getText(),textFieldNumero.getText(),textFieldDistrito.getText(),textFieldCiudad.getText(),textFieldProvincia.getText(),textFieldCodigoPostal.getText(),textFieldTelefono.getText());
	...
	public boolean camposVacios(String descripcion, String edad){
		return descripcion.equals("") || edad.equals("");
	}
