...
public class ConsultaHospitales extends JDialog {
	...
	public static void main(String[] args) {
		try {
			ConsultaHospitales dialog = new ConsultaHospitales();
	...
	public ConsultaHospitales() {
		...
		contentPanel.setLayout(null);
		{
			...
			datos = Consultas.traerEspecialidades();
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						DefaultTableModel datos;
						dispose();
						datos = Consultas.traerHospitalesPorEspecialidad(claveDeFilaClickeada);
						// Aca pensamos que claveDeFila es el ID de la especialidad (SI).
						//tabla.setVisible(false);
						MostrarTabla mostrarHospitales = new MostrarTabla("Hospitales");
						mostrarHospitales.setModal(true);
						mostrarHospitales.CargarTabla(datos);
						mostrarHospitales.setVisible(true);
					}
				});
